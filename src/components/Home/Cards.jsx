...
const Cards = ({ home, setInputDiv, data , setUpdatedData}) => {
    ...
    const handleCompleteTask = async (id) => {
        ...
        try {
            const response = await axios.put(`https://task-manager-backend-8cyi.onrender.com/api/tasks/update-complete-task/${id}`, {}, { headers })
    ...
    const handleImportant = async (id) =>{
        ...
        try{
            const response = await axios.put(`https://task-manager-backend-8cyi.onrender.com/api/tasks/update-imp-task/${id}`,{},{headers})
    ...
    const deleteTask = async(id) =>{
        ...
        try{
        const response = await axios.delete(`https://task-manager-backend-8cyi.onrender.com/api/tasks/delete-task/${id}`,{headers})
        console.log(response)
        }
        catch(error){
            console.log(error)
